...
!REAL(ReKi), INTENT(INOUT)   :: to_SC(*)         ! DATA to the super controller
    ...
    CHARACTER(LEN=size(avcoutname)) :: kgenref_rootname 
    ...
    READ (UNIT = kgen_unit) kgenref_rootname 
...
IF (kgen_mainstage) THEN 
    ...
    CALL kv_discon_character_size_avcoutname__("rootname", check_status, rootname, kgenref_rootname) 
...
!verify state subroutine for kv_discon_character_size_avcoutname__ 
RECURSIVE SUBROUTINE kv_discon_character_size_avcoutname__(varname, check_status, var, kgenref_var) 
    CHARACTER(LEN=*), INTENT(IN) :: varname 
    TYPE(check_t), INTENT(INOUT) :: check_status 
    CHARACTER(LEN=size(avcoutname)), INTENT(IN) :: var, kgenref_var 
    INTEGER :: check_result 
    LOGICAL :: is_print = .FALSE. 
      
    character(LEN=size(avcoutname)) :: diff 
...
END SUBROUTINE kv_discon_character_size_avcoutname__ 
