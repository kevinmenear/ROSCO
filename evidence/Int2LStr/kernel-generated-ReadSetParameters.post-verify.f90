...
!Generated at : 2026-08-11 16:59:29 
!KGEN version : 0.8.1 
...
SUBROUTINE readcontrolparameterfilesub(kgen_unit, kgen_measure, kgen_isverified, kgen_filepath) 
    USE kgen_utils_mod
    USE kgen_utils_mod
    USE kgen_utils_mod
    ...
    INTEGER(KIND=intki) :: i 
    CHARACTER(LEN=1024) :: ol_string 
    ...
    CHARACTER(LEN=1024) :: kgenref_ol_string 
    ...
    READ (UNIT = kgen_unit) ol_string 
      
    !extern output variables 
      
    !local output variables 
    READ (UNIT = kgen_unit) kgenref_ol_string 
    ...
    !call to kgen kernel 
                        ...
                        IF (kgen_mainstage) THEN 
                            ...
                            CALL kv_kgen_readcontrolparameterfilesub_subp0("ol_string", check_status, ol_string, &
                            &kgenref_ol_string) 
                        ...
                        OL_String   = TRIM(OL_String)//' Cable'//TRIM(Int2LStr(I))//' '
                            ...
                            IF (check_status%rank==0) THEN 
                                WRITE (*, *) "Int2LStr : Time per call (usec): ", kgen_measure 
                            END IF   
                        END IF   
                        IF (kgen_warmupstage) THEN 
                        END IF   
