...
double PIIController(double vit_unused_error, double error2, double kp, double ki, double ki2, double minValue, double maxValue, double DT, double I0, piparams_t* piP, int32_t reset, int* inst) {
    ...
    const double error = 0.0;  // STUB: input blinded
    const int i = *inst - 1;
