...
report.append("unreachable declaration was made -- and NOT the five that are still open in")
...
report.append("")
report.append("Four of the 54 -- 08ce3b56, 17de888e, 9e4b76b0, cb35366f -- are KILLED in")
report.append("the scored artifact. Their rows are the reason: each named an ADMISSIBLE")
report.append("record the corpus did not contain, R14 gained it, and the sweep then killed")
report.append("exactly those four and nothing else.")
