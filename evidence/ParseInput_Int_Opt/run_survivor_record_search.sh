...
report.append("")
report.append("The two still open, 4f89b00b and e8cf2d25, are ONE gap: `is_eol` accepts CR")
report.append("and LF, and no record in any corpus this campaign generates contains either")
report.append("byte. Neither is a NONE this search failed to explain -- the search's own")
report.append("alphabet has no CR or LF either, and that is stated rather than hidden.")
...
report.append("")
report.append(f"RECORD SPACE: {len(baselines)} records, IN TWO PARTS, and the split is the")
