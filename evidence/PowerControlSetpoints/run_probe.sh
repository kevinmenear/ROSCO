...
#
#   bash evidence/PowerControlSetpoints/run_probe.sh <probe.cpp> <out.json> "<what it counts>"
#
...
CPP=translations/ControllerBlocks/powercontrolsetpoints.cpp

cp "$PROBE" "$CPP"
bash scripts/harness.sh PowerControlSetpoints ControllerBlocks powercontrolsetpoints \
