#!/bin/bash
# ONE differential-harness red test per invocation, for unit #44
# `YawRateControl`.
#
#   bash scripts/run_if_time_remains.sh 300 \
#       bash evidence/YawRateControl/run_harness_redtest.sh <stub.cpp> <out.json> "<what was perturbed>"
#
...
# the corpus that proves the harness can fail. The generating run wrote 8036
...
# kills in this campaign have left the edit behind. COMMIT THE TRANSLATION FIRST:
