...
#
#   bash evidence/unwrap/run_harness_stub.sh <stub.cpp> <out.json> "<what was cut>"
#
...
# `translations/Functions/unwrap.cpp` to `unwrap.hpp`, so swapping that file is
...
bash scripts/harness.sh unwrap Functions unwrap rosco/controller/src/Functions.f90 \
