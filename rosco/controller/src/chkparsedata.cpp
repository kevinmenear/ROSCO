// C++ implementation of Fortran function: ChkParseData
...
// ChkParseData -- not here: integration does not verify anything.
...
extern "C" {
    void chkparsedata_c(char* Words, int len_Words, char* ExpVarName, int len_ExpVarName, char* FileName, int len_FileName, int FileLineNum, errorvariables_view_t* ErrVar) {
        ChkParseData(Words, len_Words, ExpVarName, len_ExpVarName, FileName, len_FileName, FileLineNum, ErrVar);
    }
}
