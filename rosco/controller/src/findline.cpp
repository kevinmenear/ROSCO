// C++ implementation of Fortran function: FindLine
...
// FindLine -- not here: integration does not verify anything.
...
extern "C" {
    void findline_c(char* FileLines, int n_FileLines, int len_FileLines, char* ParamName, int len_ParamName, int32_t* FoundLine, char* Line, int* LineNum, int has_AryLen, int AryLen) {
        FindLine(FileLines, n_FileLines, len_FileLines, ParamName, len_ParamName, FoundLine, Line, LineNum, has_AryLen, AryLen);
    }
}
