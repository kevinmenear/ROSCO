// C++ implementation of Fortran function: ParseDbAry_Opt
...
// ParseDbAry_Opt -- not here: integration does not verify anything.
...
extern "C" {
    void parsedbary_opt_c(char* FileLines, int n_FileLines, int len_FileLines, char* ParamName, int len_ParamName, CFI_cdesc_t* Ary, int AryLen, char* FileName, int len_FileName, errorvariables_view_t* ErrVar, int has_AllowDefault, int32_t AllowDefault, int has_UnEc, int UnEc) {
        ParseDbAry_Opt(FileLines, n_FileLines, len_FileLines, ParamName, len_ParamName, Ary, AryLen, FileName, len_FileName, ErrVar, has_AllowDefault, AllowDefault, has_UnEc, UnEc);
    }
}
