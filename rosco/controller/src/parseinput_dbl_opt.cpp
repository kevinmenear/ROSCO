// C++ implementation of Fortran function: ParseInput_Dbl_Opt
...
// ParseInput_Dbl_Opt -- not here: integration does not verify anything.
...
extern "C" {
    void parseinput_dbl_opt_c(char* FileLines, int n_FileLines, int len_FileLines, char* VarName, int len_VarName, double* Variable, char* FileName, int len_FileName, errorvariables_view_t* ErrVar, int has_AllowDefault, int32_t AllowDefault, int has_UnEc, int UnEc) {
        ParseInput_Dbl_Opt(FileLines, n_FileLines, len_FileLines, VarName, len_VarName, Variable, FileName, len_FileName, ErrVar, has_AllowDefault, AllowDefault, has_UnEc, UnEc);
    }
}
