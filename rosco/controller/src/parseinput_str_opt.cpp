// C++ implementation of Fortran function: ParseInput_Str_Opt
...
// ParseInput_Str_Opt -- not here: integration does not verify anything.
...
extern "C" {
    void parseinput_str_opt_c(char* FileLines, int n_FileLines, int len_FileLines, char* VarName, int len_VarName, char* Variable, int len_Variable, char* FileName, int len_FileName, errorvariables_view_t* ErrVar, int has_AllowDefault, int32_t AllowDefault, int has_UnEc, int UnEc) {
        ParseInput_Str_Opt(FileLines, n_FileLines, len_FileLines, VarName, len_VarName, Variable, len_Variable, FileName, len_FileName, ErrVar, has_AllowDefault, AllowDefault, has_UnEc, UnEc);
    }
}
