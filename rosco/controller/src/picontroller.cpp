// C++ implementation of Fortran function: PIController
...
// PIController -- not here: integration does not verify anything.
...
extern "C" {
    double picontroller_c(double error, double kp, double ki, double minValue, double maxValue, double DT, double I0, piparams_t* piP, int32_t reset, int* inst) {
        return PIController(error, kp, ki, minValue, maxValue, DT, I0, piP, reset, inst);
    }
}
