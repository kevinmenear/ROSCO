// C++ implementation of Fortran function: SecLPFilter
// Generated by VIT (Verified Incremental Translator)
// After verification: SecLPFilter kernel PASSED
...
extern "C" {
    double seclpfilter_c(double InputSignal, double DT, double CornerFreq, double Damp, filterparameters_t* FP, int iStatus, int reset, int* inst, int has_InitialValue, double InitialValue) {
        return seclpfilter(InputSignal, DT, CornerFreq, Damp, FP, iStatus, reset, inst, has_InitialValue, InitialValue);
    }
}
